...
// ===========================================================================
// Ghost A* — turn-biased, belt-transparent pathfinder for Phase 2 routing
// ===========================================================================

/// Turn-biased A* that treats hard obstacles as impassable but ghosts through
/// existing belts (recording each ghost crossing tile).
///
/// - `hard_obstacles`: tiles that block routing entirely (machines, poles, pipes).
/// - `existing_belts`: tiles that already hold a belt; A* may path through them
